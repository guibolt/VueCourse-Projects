<template>
  <div id="app">
    <div class="jumbotron jumbotron-fluid">
      <div class="container">
        <h1 class="display-4 text-center">Formulários no Vue</h1>
        <p class="lead text-center">Treinando a manipulação de formulários</p>
      </div>
    </div>
          ...
          <form>
            ...
            <div class="form-group">
              ...
              <textarea
                ...
                v-model.lazy="desenvolvedor.biografia"
              ></textarea>
            </div>
